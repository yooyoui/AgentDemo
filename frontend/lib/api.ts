...
export type Health = { status: string; provider: "deepseek" | "demo"; model: string; model_status: "configured" | "demo"; research: string; research_model?: string; research_fallback?: string | null; external_data_transmission: "enabled" | "blocked" };
...
export const api = {
  ...
  resolveOrganization: (body: { name: string; region: string; industry: string; force_refresh?: boolean }) => request<OrganizationResolution>("/v1/organization-identities/resolve", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(body) }),
